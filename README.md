...
| 算法 | 总耗时 | 平均每查询 | QPS |
|------|--------|------------|-----|
| 哈希查找 | 102.7µs | 103ns | ~9,708,743 |
| 二分查找 | 194.6µs | 195ns | ~5,128,205 |
...
| 算法 | 查询时间 | 优势 |
|------|----------|------|
| 哈希查找 | 29-34ns | 直接判断key不存在 |
| 二分查找 | 45-175ns | 需要完整二分查找 |
| 布隆过滤器 | ~175ns | 可提前过滤，但仍有二分查找 |
